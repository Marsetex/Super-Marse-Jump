...
public class Character {
    ...
    public void initAnimationen() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            try {
                bImage1 = ImageIO.read(new File("mario" + (i + 1) + ".png"));
            } catch (IOException e) {
        ...
        for (int m = 0; m < 3; m++) {
            ...
            try {
                bImage2 = ImageIO.read(new File("mario" + (m + 4) + ".png"));
            } catch (IOException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            }
    ...
    public void paintAnimation(Graphics g) {
        ...
        if (links == true) g.drawImage(wAnimationL[animation], mx_pos, my_pos, null);

        // Animation f�r "nach rechts laufen"
        else g.drawImage(wAnimationR[animation], mx_pos, my_pos, null);
